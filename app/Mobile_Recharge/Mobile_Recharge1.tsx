...
import { FlatList, Pressable, Text, TextInput, View, Image,Alert } from 'react-native';
...
export default function Mobile_Recharge1() {
  ...
  const nextfunction =()=>{
    ...
    navigation.navigate("Mobile_Recharge2");
  }
...
loading ? (
  <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
    <Text className='text-2xl text-red-600'>Loading...</Text>
  </View>
) : (
    <FlatList
    data={data}
